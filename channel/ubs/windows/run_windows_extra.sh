...
do
    ...
    sed -i "s/DIST/${i}/g" com_res_extra.rst
    ...
    pmemd.cuda -O -i ../ubs_prod_extra.in -o window_${i}_extra.out -p ../$prmtop -c frame_${i}.rst -r window_${i}_extra.rst -x window_${i}_extra.nc -inf window_${i}_extra.mdinfo -ref ../100ns.rst &> junk &
